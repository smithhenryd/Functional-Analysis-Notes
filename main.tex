...
\subsection{Vector Spaces: a Review}
...
\begin{thm}[Continuity of the norm]
...
In Theorem \ref{}, however, we prove that this normed space $(X, \| \cdot \|_p)$ can be completed. The completion is denoted by $L^p[a, b]$ and is a Banach space. As we shall see in Theorem \ref{}, the operations of the vector space $X$ can be extended to the completion of $X$.\newline
